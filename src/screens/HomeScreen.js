  ...
  const HomeScreen = ({ navigation }) => {
    ...
    return (
      <>
            ...
            <View style={styles.paginationDots}>
              {favoriteMosques.map((_, index) => (
                <View
                  ...
                  style={[
                    styles.dotH,
                    activeIndex === index && styles.activeDotH,
                  ]}
                />
              ))}
            </View>
            <TouchableOpacity onPress={() => navigation.navigate("MenuScreen")}>
              <MenuIcon style={styles.menuIconH} />
            </TouchableOpacity>
          </View>
        )}
        ...
        <Swiper
          loop={false}
          showsPagination={false} // Disable default pagination if you are using custom dots
